...
const About = () => (
  <section class="about" id="about">
      <div class="about__title"><h2>О нас</h2></div>
      <div class="about__text">
        <div class="about__deco"></div>
        <div class="about__items">
          <p class="about__item">Мы рады видеть вас! Мы работаем для Вас с 2003 года. 15 лет мы наблюдаем, как с каждым днем все больше людей заказывают жд билеты через интернет.</p>
